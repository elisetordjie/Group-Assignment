...
```{r, echo = FALSE, fig.cap=cap}
cap <- paste0(
    "**Figure 3**", ": Effect of different treatments on the Mortality of Pheritimoid Earthworms") 
...
```{r, echo=FALSE,fig.cap=cap}
cap <- paste0(
    "**Figure 4**", ": Effect of different treatments on Pheritimoid earthworm mortality in Assay 2. ",
    " Letters indicates Tukeys HSD posthoc comparisons. ",
    " Same letter indicates non-significant differences. ")
...
```{r, echo=FALSE, fig.cap=cap}
cap <- paste0(
    "**Figure 5**", ": Effect of different treatments on the Mortality of Pheritimoid Earthworms in Assay 3") 
...
```{r, echo=FALSE, fig.cap=cap}
cap <- paste0(
    "**Figure 6**", ": Effect of different treatments on Pheritimoid earthworm mortality. ",
    " Letters indicates Tukeys HSD posthoc comparisons. ",
    " Same letter indicates non-significant differences. ")
  plot(hsd3)
...
```{r, echo=FALSE, fig.cap=cap}
cap <- paste0(
    "**Figure 6**", ": Effect of different treatments on the Mortality of Pheritimoid Earthworms in Assay 1") 
plot(KAssay1)
...
```{r, echo=FALSE, fig.cap=cap}
cap <- paste0(
    "**Figure 7**", ": Effect of different treatments on the Mortality of Pheritimoid Earthworms in Assay 2") 
plot(KAssay2)
...
```{r,echo=FALSE,fig.cap=cap}
cap <- paste0(
    "**Figure 8**", ": Effect of different treatments on the Mortality of Pheritimoid Earthworms in Assay 3") 
plot(KAssay3)

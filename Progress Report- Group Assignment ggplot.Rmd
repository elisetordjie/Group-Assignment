...
L <- hsd$groups$groups[order(row.names(hsd$groups))]
...
```
```{r}
d0 <- data.frame(l= L,Treatments=levels(factor(Assay_1$Treatments)))



ggplot(Assay_1, aes(x=Treatments, y=TMortality, fill=Treatments ))+
  geom_boxplot()+
  geom_text(data=d0, aes(x= Treatments, y=1.7, label=l))          
```
...
```{r, echo=FALSE,fig.cap=cap}
L <-  hsd2$groups$groups[order(row.names(hsd2$groups))]
d0 <- data.frame(l= L,Treatments=levels(factor(Assay_2$Treatments)))



ggplot(Assay_2, aes(x=Treatments, y=TMortality, fill=Treatments ))+
  geom_boxplot()+
  geom_text(data=d0, aes(x= Treatments, y=1.3, label=l))   
...
L <-  hsd3$groups$groups[order(row.names(hsd3$groups))]
d0 <- data.frame(l= L,Treatments=levels(factor(Assay_3$Treatments)))



ggplot(Assay_3, aes(x=Treatments, y=TMortality, fill=Treatments ))+
  geom_boxplot()+
  geom_text(data=d0, aes(x= Treatments, y=1.7, label=l))   
